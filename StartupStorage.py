...
class StartupStorage:
    def __init__(self, file_path, value=None):
        ...
        self.fieldnames = ['Rang','startup_name','startup_amount_invested','startup_article_publication_date','startup_more_inf_url','startup_levée_de_fonds','startup_founders','startup_Number_of_employees','startup_web_site_url','startup_right_web_site_url','startup_valid_web_site_url','startup_linkedin_url','startup_facebook_url','startup_instagram_url','startup_phone','startup_email','startup_address','startup_phrasechoc','profiles','founder_name','founder_description','founder_profile_url','valid_profile_description']
    ...
    def insert_startup(self, startup):
        data = {
            ...
            'valid_profile_description' : startup.valid_profile_description
        }
